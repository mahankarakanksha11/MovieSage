...
# The fit method calculates the k nearest neighbors of a given test_point, extracts their categories, 
# counts the occurrences of each category, and finally assigns the category with the highest count to 
# the category_assigned attribute. This process is the essence of the k-nearest neighbors classification
# algorithm.